    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">New Animal</li>
            </ol>
        </nav>
    </div>
    <div class="container">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted">Add new animal</h6>
                            </div>
                        ...
                        <hr>
                        <form action="{{ route('animal.store') }}" method="POST" class="row g-3">
                            @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="animal-status-id" class="form-select" name="animal_status_id">
                                    ...
                                    @forelse ($status as $s)
                                        <option value="{{ $s->id }}"
                                                {{ old('animal_status_id') == $s->id ? 'selected' : '' }}>
                                            {{ $s->name }}
                                        </option>
                                    @empty
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                           ...
                                           {{ old('is_adoptable') ? 'checked' : '' }} value="1">
